...
def create(config, data):
    ...
    for id, obj in data.items():
        ...
        student_type = ET.SubElement(soa, "studentType")
        student_type.text = "phd"
        
        prog_title = ET.SubElement(soa, "programme")
        prog_title.text = obj["description"]
        
        # Temporarily commented pending addition of user creation
    ...
    with open(config["phd_persons_xml"], "w", encoding="utf-8") as f:
